"""CBraMod backbone (vendored, Apache-2.0).

Upstream: https://github.com/wjq-learning/CBraMod
Weights: https://huggingface.co/weighting666/CBraMod
Paper: Wang et al., CBraMod (ICLR 2025), arXiv:2412.07236

Import path adapted for this repo (relative / flat). Do not re-publish gated
derivatives beyond head-only adapters; keep attribution.
"""
...
except ImportError:  # flat Kaggle dataset layout
    from criss_cross_transformer import TransformerEncoderLayer, TransformerEncoder
